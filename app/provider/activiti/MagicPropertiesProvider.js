...
import assignee from './parts/Assignee';
  ...
  this.getGroups = function(element) {
    ...
    return function(groups) {
      ...
      if(is(element, 'bpmn:UserTask')){
        groups.push(createUserTaskProp(element, translate));
      }
...
// 构建user task用的属性
function createUserTaskProp(element, translate) {
  const userTaskGroup = {
    id: 'ActivitiUserTaskProp',
    label: translate('Activiti相关的节点信息'),
    entries: assignee(element)
  };
